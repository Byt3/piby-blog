...
public class Category {
	...
	private User user;
	@ManyToMany
	@JoinTable(name = "category2project", joinColumns = @JoinColumn(name = "category_id", referencedColumnName = "id"), inverseJoinColumns = @JoinColumn(name = "post_id", referencedColumnName = "id"))
